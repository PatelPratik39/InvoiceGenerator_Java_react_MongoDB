...
const TemplateGrid = ({onTempateClick}) => {
  return (
    <>
        <div className="row g-3">
            {templates.map(({id, label, image}) => (
                <div className='col-12 col-sm-6 col-lg-4' key={id}>
                    <div className="border rounded shadow-sm overflow-hidden template-hover cursor-pointer" title={label} onClick={() => onTempateClick(id)}>
